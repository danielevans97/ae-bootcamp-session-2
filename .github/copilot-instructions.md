...
- [UI Guidelines](../docs/ui-guidelines.md) - UI component library, color palette, typography, and accessibility requirements
- [Testing Guidelines](../docs/testing-guidelines.md) - Unit, integration, and E2E testing conventions and principles
- [Coding Guidelines](../docs/coding-guidelines.md) - Formatting rules, import organization, linting, naming conventions, and code quality principles
